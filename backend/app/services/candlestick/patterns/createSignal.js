...
function makeSignal({
    ...
    return {
        ...
        context: {
            ...
            sma: context?.sma,
            fastSma: context?.fastSma,
            slowSma: context?.slowSma,
            slope: context?.slope,
            normalizedMoveAtr: context?.normalizedMoveAtr,
            efficiencyRatio: context?.efficiencyRatio,
            structure: context?.structure,
            evidence: context?.evidence,
            swingHigh: context?.swingHigh,
            swingLow: context?.swingLow,
            barsAnalyzed: context?.barsAnalyzed,
